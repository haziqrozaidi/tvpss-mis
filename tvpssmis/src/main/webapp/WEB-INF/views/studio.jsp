...
<head>
    ...
    <title>Resource Management - Studio Information | TVPSS</title>
    <!-- Bootstrap CSS -->
	...
	<div class="d-flex" style="min-height: 100vh;">
		<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
			...
			<ul class="nav nav-pills flex-column mb-4">
				...
				<li><a href="/tvpssmis/resources/studio" class="nav-link active text-white"> <svg
							class="bi me-2" width="16" height="16">
		 ...
		 <div class="container-fluid p-4">
	        <h1 class="mb-4">Studio Information</h1>
	        ...
	        <table class="table table-striped table-hover">
	            ...
	            <tbody>
	                <tr>
	                    <td>SMK Teknik Multimedia</td>
	                    <td>Advanced</td>
	                    <td>
	                        <span class="studio-rating">
	                            ★★★★☆
	                        </span>
	                    </td>
	                    <td>2022-12-15</td>
	                    <td>
	                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#studioDetailsModal">View Details</button>
	                    </td>
	                </tr>
	                <tr>
	                    <td>SMK Kreatif Media</td>
	                    <td>Intermediate</td>
	                    <td>
	                        <span class="studio-rating">
	                            ★★★☆☆
	        ...
	        <!-- Studio Upgrade and Maintenance Plan -->
<h2 class="mt-4 mb-3">Studio Upgrade and Maintenance Plan</h2>
<div class="row">
    <div class="col-md-4">
        <div class="card equipment-card">
            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <strong>SMK Digital Broadcast</strong>
                        <span class="badge bg-primary float-end">Scheduled: Q3 2023</span>
                    </li>
                    <li class="mb-2">
                        <strong>SMK Kreatif Media</strong>
                        <span class="badge bg-primary float-end">Scheduled: Q4 2023</span>
                    </li>
                    <li>
                        <strong>SMK Multimedia Utama</strong>
                        <span class="badge bg-primary float-end">Scheduled: Q1 2024</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <span class="badge bg-secondary float-end">Low Priority</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card equipment-card">
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <small class="text-muted">Total Annual Budget: RM 350,000</small>
                </div>
            </div>
        </div>
    </div>
	        ...
	        <div class="modal-dialog modal-lg">
	            <div class="modal-content">
	                <div class="modal-header">
	                    <h5 class="modal-title">SMK Teknik Multimedia - Studio Details</h5>
	                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
	                </div>
	                <div class="modal-body">
	                    <div class="row">
	                        <div class="col-md-6">
	                            <h6>Studio Specifications</h6>
	                            <p>Size: 120 sq meters</p>
	                            <p>Ceiling Height: 4.5 meters</p>
	                            <p>Acoustic Treatment: Advanced</p>
	                        </div>
	                        <div class="col-md-6">
	                            <h6>Technical Specifications</h6>
	                            <p>Cameras: 4K Resolution</p>
	                            <p>Lighting: LED Panel</p>
	                            <p>Audio System: Professional Grade</p>
	                        </div>
	                    </div>
	                </div>
	            </div>
