...
<head>
    ...
    <style>
        * {
        ...
        .navbar :where(.logo-image) {
            width: 50px;
            cursor: pointer;
        }

        .navbar :where(.user-image) {
            width: 32px;
            cursor: pointer;
            border-radius: 50%;
        }
    ...
    <div class="d-flex" style="min-height: 100vh;">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                ...
                </svg> <span class="fs-4">TVPSS MIS</span>
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item"><a href="#" class="nav-link text-white" aria-current="page"> <svg
                    ...
                    <li><a href="#" class="nav-link active text-white"> <svg class="bi me-2" width="16" height="16">
                        ...
                        <tr>
                            <td>
                                <div class="content-item">
                                    ...
                                    <div>
                                        <p class="content-title">Content 1</p>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="UpdateContentInformation.html">Edit</a>
                                        <a href="#">Delete</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="content-item">
                                    <div class="thumbnail"></div>
                                    <div>
                                        <p class="content-title">Content 2</p>
                                        <p class="content-description">Content Description</p>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="content-item">
                                    <div class="thumbnail"></div>
                                    <div>
                                        <p class="content-title">Content 3</p>
                                        <p class="content-description">Content Description</p>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="content-item">
                                    <div class="thumbnail"></div>
                                    <div>
                                        <p class="content-title">Content 4</p>
                                        <p class="content-description">Content Description</p>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="content-item">
                                    <div class="thumbnail"></div>
                                    <div>
                                        <p class="content-title">Content 5</p>
                                        <p class="content-description">Content Description</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="UpdateContentInformation.html">Notify Applicant</a>
                                        <a href="#">Delete</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="content-item">
                                    <div class="thumbnail"></div>
                                    <div>
                                        <p class="content-title">Content 6</p>
                                        <p class="content-description">Content Description</p>
                                    </div>
                                </div>
                            </td>
