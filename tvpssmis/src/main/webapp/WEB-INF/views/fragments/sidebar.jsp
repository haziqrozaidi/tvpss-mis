...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
    ...
    <c:when test="${user.role.roleName == 'Student'}">
		...
		<c:if test="${role.roleName == 'Teacher'}">
			<li><a href="${pageContext.request.contextPath}/program/manage"
		...
		<c:if
			test="${role.roleName == 'Admin' || role.roleName == 'JPNJ' || role.roleName == 'PPD'}">
			<li><a href="/tvpssmis/studios/approvals"
				class="nav-link text-white"> <svg class="bi me-2" width="16"
						height="16">
                    <use xlink:href="#table" />
                </svg> Approvals
	...
	<div class="dropdown">
		<a href="#"
			...
			class="rounded-circle me-2" /> <strong>${role.roleName}</strong>
		</a>
			...
			<li>
				<form action="${pageContext.request.contextPath}/logout"
					...
					<input type="hidden" name="${_csrf.parameterName}"
						...
						onclick="this.closest('form').submit(); return false;">Sign
						out</a>
				</form>
			</li>
		</ul>
