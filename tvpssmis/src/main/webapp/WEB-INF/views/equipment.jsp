...
<head>
    ...
    <title>Resource Management - Equipment Inventory | TVPSS</title>
    <!-- Bootstrap CSS -->
	...
	<div class="d-flex" style="min-height: 100vh;">
		<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
			...
			<ul class="nav nav-pills flex-column mb-4">
				...
				<li><a href="/tvpssmis/resources/equipment" class="nav-link active text-white"> <svg
							class="bi me-2" width="16" height="16">
		...
		<div class="container-fluid p-4">
	        <h1 class="mb-4">Equipment Inventory</h1>
	            ...
	            <div class="container-fluid">
	                        ...
	                        <div class="d-flex align-items-end gap-3">
	                            <div class=" flex-grow-1">
	                                ...
	                                <select id="schoolSelect" class="form-select">
	                                    ...
	                                    <option value="smk1">SMK Teknologi Media</option>
	                                    <option value="smk2">SMK Komunikasi Kreatif</option>
	                                    <option value="smk3">SMK Multimedia Inovasi</option>
	                                    <option value="smk4">SMK Penyiaran Maju</option>
	                                    <option value="smk5">SMK Digital Masa Depan</option>
	                                </select>
	                            </div>
	                            <div>
	                                <button id="searchSchool" class="btn btn-primary mt-4">
	                ...
	                <div class="card">
	                    <div class="card-header bg-primary text-white">
	                        <h3 class="mb-0">SMK Teknologi Media Resources</h3>
	                    </div>
	                    <table class="table table-striped table-hover">
	                        ...
	                        <tbody>
	                            <tr>
	                                ...
	                                <td>
	                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editEquipmentModal">
	                            ...
	                            <tr>
	                                ...
	                                <td>Needs Partial Replacement</td>
	                                <td>
	                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editEquipmentModal">
	                                        <i class="fas fa-edit"></i>
	                                    </button>
	                ...
	                <div class="card mt-4">
	                    <div class="card-body bg-light">
	                        ...
	                        <div class="row">
	                            <div class="col-md-6">
	                                <p><strong>Total Equipment Types:</strong> 5</p>
	                                <p><strong>Total Equipment Pieces:</strong> 16</p>
	                            </div>
	                            <div class="col-md-6">
	                                <p><strong>Last Updated:</strong> 15 June 2023</p>
	                                <p><strong>Condition Status:</strong> 
	                                    <span class="badge bg-success">80% Good/Excellent</span>
	                                </p>
	                            </div>
	                        </div>
	                    </div>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter equipment status">
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label class="form-label">Equipment Name</label>
                            <input type="text" class="form-control" value="Professional Video Camera">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Quantity</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Status</label>
                            <input type="text" class="form-control" value="Fully Operational">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-warning">Update Equipment</button>
                </div>
            </div>
        </div>
    </div>
