...
<head>
    ...
    <title>Resource Management - Register Studio | TVPSS</title>
    <!-- Bootstrap CSS -->
...
<body>
	            ...
	            <div class="col-md-12">
	                ...
	                <form>
	                    ...
	                    <div class="form-section">
	                        ...
	                        <div class="row">
	                            <div class="col-md-6 mb-3">
	                                ...
	                                <input type="text" class="form-control" placeholder="Enter Studio Name" required>
	                            </div>
	                            <div class="col-md-6 mb-3">
	                                <label class="form-label">School Name</label>
	                                <select class="form-select" required>
	                                    <option value="">Select School</option>
	                                    <option value="SMK Teknik Kuala Lumpur">SMK Teknik Kuala Lumpur</option>
	                                    <option value="SMK Seri Permata">SMK Seri Permata</option>
	                        ...
	                        <div class="row">
	                            <div class="col-md-6 mb-3">
	                                ...
	                                <input type="text" class="form-control" placeholder="Enter Studio Location" required>
	                            </div>
	                            <div class="col-md-6 mb-3">
	                                <label class="form-label">Studio Establishment Date</label>
	                    ...
	                    <div class="form-section">
	                            ...
	                            <div class="crew-member">
	                                <div class="row">
	                                    <div class="col-md-4 mb-3">
	                                        ...
	                                        <input type="text" class="form-control" placeholder="Enter Crew Member Name">
	                                    </div>
	                                    <div class="col-md-4 mb-3">
	                        ...
	                        <button type="button" class="btn btn-secondary" id="addCrewMember">
	                    ...
	                    <div class="form-section">
	                        <h4 class="mb-3">Equipment Inventory</h4>
	                        <div class="row">
	                            <div class="col-md-4 mb-3">
	                                ...
	                                <select class="form-select">
	                                    ...
	                                    <option value="Professional Video Camera">Professional Video Camera</option>
	                            ...
	                            <div class="col-md-4 mb-3">
	                                ...
	                                <select class="form-select">
	                                    ...
	                                    <option value="Wireless Lavalier">Wireless Lavalier</option>
	                                    <option value="Shotgun Mic">Shotgun Mic</option>
	                            ...
	                            <div class="col-md-4 mb-3">
	                                ...
	                                <select class="form-select">
	                                    ...
	                                    <option value="Basic Ring Light">Basic Ring Light</option>
	                                    <option value="Professional Lighting Kit">Professional Lighting Kit</option>
	                    ...
	                    <div class="form-section">
	                        ...
	                        <div class="row">
	                            <div class="col-md-6 mb-3">
	                                ...
	                                <input type="url" class="form-control" placeholder="Enter YouTube Channel URL">
	                            </div>
	                            <div class="col-md-6 mb-3">
	                                <label class="form-label">Studio Status</label>
	                                <select class="form-select">
	                    ...
	                    <div class="text-center">
	                        <button type="submit" class="btn btn-primary btn-lg">Register Studio</button>
	                    </div>
	                </form>
	            </div>
	        </div>
    ...
    <script>
        // JavaScript to dynamically add crew members
        document.getElementById('addCrewMember').addEventListener('click', function() {
            ...
            const newCrewMember = document.querySelector('.crew-member').cloneNode(true);
            
            // Clear input values of cloned section
            newCrewMember.querySelectorAll('input, select').forEach(input => {
                input.value = '';
            });
            
            crewSection.appendChild(newCrewMember);
        });
    </script>
</body>
</html>
