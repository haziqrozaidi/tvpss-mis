...
<head>
    ...
    <title>Resource Management - Performance Metrics | TVPSS</title>
    <!-- Bootstrap CSS -->
	...
	<div class="d-flex" style="min-height: 100vh;">
		<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
			...
			<ul class="nav nav-pills flex-column mb-4">
				...
				<li><a href="/tvpssmis/resources/performance" class="nav-link active text-white"> <svg
							class="bi me-2" width="16" height="16">
	        ...
	        <div class="row g-4">
	            ...
	            <div class="col-md-12">
	                <div class="card bg-primary text-white">
	                    <div class="card-body">
	                        <h5 class="card-title">Overall Program Performance</h5>
	                        <div class="row">
	                            <div class="col-md-3">
	                                <strong>Total Schools:</strong> 24
	                            </div>
	                            <div class="col-md-3">
	                                <strong>Active Programs:</strong> 22
	                            </div>
	                            <div class="col-md-3">
	                                <strong>Average Performance:</strong> 85%
	                            </div>
	                            <div class="col-md-3">
	                                <strong>Resource Utilization:</strong> 78%
	                            </div>
	                        </div>
	                    </div>
	                </div>
	            ...
	            <div class="col-md-4">
	                <div class="card metric-card">
	                    <div class="card-header bg-success text-white">
	                        SMK Teknologi Kajang
	                    </div>
	                    <div class="card-body">
	                        <div class="row">
	                            <div class="col-6">
	                                <small>Studio Equipment</small>
	                                <div class="progress">
	            ...
	            <!-- Repeat similar cards for other schools -->
	            <div class="col-md-4">
	                <div class="card metric-card">
